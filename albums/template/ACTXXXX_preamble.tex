...
%
% 使用方法：
%   \input{../preamble.tex}  を ACTXXXX_main.tex のプリアンブルに記述する
%
% 依存パッケージ：
...
\newcommand{\dgb}[1]{%
    ...
    \fbox{%
        ...
        \fbox{\makebox[1.5cm]{\textbf{\textgt{#1}}}}%
    }%
    }%
}
